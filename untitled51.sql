...
--concat, upper, lower, initcap, rtrim, ltrim, trim, length, lpad, rpad
    ...
    '       Rahul Dravid'
    'Rahul Dravid'
    SELECT (INITCAP('   Rahil Dravid    ')) NAME FROM DUAL;
    'Rahul Dravid'
  ...
  If COMMISSION_PCT is null then commission would be SALARY * .IS
  */
